...
<head>
  ...
  <title>Escola Virtual - Login</title>
  ...
  <div class="container col-xl-10 col-xxl-8  " style="height: 95vh; padding:8% 30px">
    <div class="row align-items-center g-lg-5 py-4 ">
      <div class="col-lg-7 text-center text-lg-start">
        <a href="home" class="d-block link-dark text-decoration-none ">
          <img src="../img/logo.png" class="rounded mx-auto d-block" alt="...">
        </a>
        <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3 text-center">Escola Virtual</h1>
