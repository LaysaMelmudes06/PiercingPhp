            ...
            <tbody>
              ...
              <tr>
                ...
                <form action="registro.php" method="POST">
                  <input type="hidden" class="form-control" id="id_joia" name="id_joia" value="<?=$joia[0]?>">
              ...
              <td class = "text-center">
              <a class="dropdown-item" onclick="modalRemover(<?=$joia[0]?>,'id_galeriaUp')">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body  ">
          <form action="remover.php" method="post">
            <input class="form-control" id="id_galeriaUp" name="id_galeriaUp" type="hidden">
